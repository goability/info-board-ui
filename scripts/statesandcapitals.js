...
let stateToggleSeconds = 7;
let refreshSolution = 5;
setInterval(updateStateCapital, stateToggleSeconds*1000);
...
function updateStateCapital(){
	...
	var elCapital = document.getElementById("component_capital");

	elState.innerHTML = state;
	elCapital.innerHTML = "???";
	
	setTimeout(() => {
		elCapital.innerHTML = capital;
	}, refreshSolution*1000);	
}